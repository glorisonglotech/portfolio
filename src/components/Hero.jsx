import { ArrowRight, Github, Linkedin, Twitter, Code2, Shield } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              Hi, I'm <span className="text-gradient text-red-500">Glorison Ouma</span>
            </h1>
            <h2 className="text-2xl lg:text-3xl font-semibold text-muted-foreground mb-6">
              MERN Stack Developer & Cybersecurity Specialist
            </h2>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <Button variant="hero" className="button-glow bg-red-500 flex">
                <a href="#projects">
                  View Projects 
                </a>
              </Button>
  ...
  <div className="relative">
    ...
    <div className="relative bg-card/50 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border-2 border-red-500 shadow-lg shadow-red-500/70">
      ...
      <div className="space-y-3 font-mono text-sm lg:text-base">
        ...
        >
          <code className="text-muted-foreground">
            security: <span className="text-green-500">"Cyber Specialist"</span>,
          </code>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <code className="text-muted-foreground">
            passion: <span className="text-green-500">"Secure code"</span>
          </code>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
